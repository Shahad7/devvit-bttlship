      ...
      {currentScreen === 'game' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10 min-h-screen flex flex-col p-2">
            {/* Fixed mobile header - no margin bottom */}
            <div className="bg-gray-800/70 backdrop-blur-md rounded-lg p-3 border border-blue-500/30 shadow-lg shadow-blue-900/20 flex-shrink-0">
              {/* Top row: Hits & Misses */}
              <div className="flex justify-between items-center mb-3">
                <div className="text-center bg-gradient-to-b from-green-700/40 to-green-900/60 py-1 px-3 rounded-md border border-green-500/30 shadow-md shadow-green-900/20 flex-1 mr-2">
                  <div className="text-green-300 font-bold text-base">{score.hits}</div>
                  <div className="text-green-400 text-xs uppercase tracking-wider">HITS</div>
                </div>
                <div className="text-center bg-gradient-to-b from-blue-700/40 to-blue-900/60 py-1 px-3 rounded-md border border-blue-500/30 shadow-md shadow-blue-900/20 flex-1 ml-2">
                  <div className="text-blue-300 font-bold text-base">{score.misses}</div>
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  onClick={() => setCurrentScreen('menu')}
                  className="px-4 py-2 bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-500 hover:to-rose-600 text-white rounded-md transition-all duration-300 transform hover:-translate-y-0.5 shadow-md shadow-red-900/30 text-sm font-medium"
                >
                  Exit
                </button>
              </div>
